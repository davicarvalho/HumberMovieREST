 ...
 * 
 */
@WebServiceClient(name = "MovieWebService", targetNamespace = "http://services/", wsdlLocation = "http://localhost:8080/My-IMDb-SOAP-WS/MovieWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MOVIEWEBSERVICE_QNAME = new QName("http://services/", "MovieWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/My-IMDb-SOAP-WS/MovieWebService?wsdl");
    ...
    public MovieWebService getMovieWebServicePort() {
        return super.getPort(new QName("http://services/", "MovieWebServicePort"), MovieWebService.class);
    }
    ...
    public MovieWebService getMovieWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services/", "MovieWebServicePort"), MovieWebService.class, features);
    }
